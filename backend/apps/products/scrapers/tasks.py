...
from apps.products.scrapers.persists import get_supermarket, sync_categories, sync_products
from apps.products.scrapers.registry import get_all_slugs, get_scraper
